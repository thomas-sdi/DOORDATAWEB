...
class Model_Door extends Model_Abstract{
	...
	public function save($data, $ignored=null, $clean=true){
		...
		if($data['FRAME_MATERIAL'] == "") $data['FRAME_MATERIAL'] = null; 
		if($data['FRAME_ELEVATION'] == "") $data['FRAME_ELEVATION'] = null; 
		if($data['FIRE_RATING_1'] == "") $data['FIRE_RATING_1'] = null; 
		if($data['LISTING_AGENCY'] == "") $data['LISTING_AGENCY'] = null; 
		if($data['HINGE_HEIGHT'] == "") $data['HINGE_HEIGHT'] = null; 
