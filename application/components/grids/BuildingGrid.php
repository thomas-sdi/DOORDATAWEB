...
class BuildingGrid extends Cmp_Custom_Grid {
	...
	public function __construct($id, $parent=null, $parentLink=null) {
      ...
      array('Field'   => 'PRIMARY_CONTACT',
        ...
        'Editable'=> false,
        'Visible' => '100'),
      'address_1'  => array('Title'          => 'Address 1','Maxlength' => '48', 'Id' => 'ADDRESS_1'),
      'address_2'  => array('Title'          => 'Address 2', 'Maxlength' => '20', 'Id' => 'ADDRESS_2'),
      'city'       => array('Title'          => 'City', 'Maxlength' => '50', 'Id' => 'CITY'),
      ...
      'zip'        => array('Title'          => 'ZIP / Postal Code', 'Maxlength' => '10', 'Id' => 'ZIP'),
   ...
   $employee = $employees[0];
      ...
      if ($acl->inheritsRole($user, 'Inspection Company Employees')) {
        $columns['company']['Visible'] = 000;
      }

      if ($acl->inheritsRole($user, 'Administrators')) {
        $columns['building_owner']['Visible'] = 000;
      }

      if ($id == 'company_buildings') {
        $columns['building_owner']['Visible'] = 000;  
      }
