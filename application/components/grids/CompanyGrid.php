...
class CompanyGrid extends Cmp_Custom_Grid {
	...
	public function __construct($id, $parent = null, $parentLink = null) {
		...
		$columns = array(
			...
			'PRIMARY_CONTACT' => array(
				...
				'Display' => 'LAST_NAME',
				'Visible' => '100',
				'Calculated' => array($this, 'joinEmployeName'),
			...
			'ZIP'        => array('Title' => 'ZIP / Postal Code', 'Maxlength' => '10', 'Id' => 'ZIP','Visible' => '011'),
	...
	public function joinEmployeName($entry){
		$primary_contact = $entry['PRIMARY_CONTACT_ID'];
		// return json_encode($entry);
		if (!$primary_contact) return '';
		$employee = Model_Employee::retrieve()->fetchEntry($primary_contact);
